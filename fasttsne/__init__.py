...
def fast_tsne(data, pca_d=None, d=2, perplexity=30., theta=0.5, normalise=0):
    """
    ...
    @param normalise    Set to 1 to normalise all vectors.
    """
    ...
    tsne = TSNE()
    Y = tsne.run(X, N, vlen, d, perplexity, theta, normalise)
    return Y
